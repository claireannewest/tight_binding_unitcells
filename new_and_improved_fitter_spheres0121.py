...
def make_invH( ### use this to calculate alpha
    ...
    m_LW_long, w0_LW_long, gam_LW_long = make_dip_masses(w=w_all, w0=wsp_long, gamNR=gamNR_long,sph_rad=sph_rad) #units are g, 1/s, 1/s
    m_LW_short, w0_LW_short, gam_LW_short = make_dip_masses(w=w_all, w0=wsp_short, gamNR=gamNR_short,sph_rad=sph_rad) #units are g, 1/s, 1/s
...
def make_alpha( #total alpha = e*x_tot*E_tot^-1
    ...
    inverted_H = make_invH(w_all=w_all,wsp_long=wsp_long, wsp_short=wsp_short,gamNR_long=gamNR_long, gamNR_short=gamNR_short,sph_rad=sph_rad)
...
def gammaEELS(
    ...
    Gam_EELS_tot = 0
    alpha_tot = make_alpha(w_all=w_all, wsp_long=wsp_long, wsp_short=wsp_short,gamNR_long=gamNR_long,gamNR_short=gamNR_short,sph_rad=sph_rad)
...
def gammaEELS_fit(raw_w, wsp_long, wsp_short, gamNR_long, gamNR_short):
    ...
    gammaEEL_long = gammaEELS(w_all=raw_w,wsp_long=wsp_long, wsp_short=wsp_short, gamNR_long=gamNR_long*gaml_scale, gamNR_short=gamNR_short*gams_scale,ebeam_loc=np.array([0,358E-7]),sph_rad=sph_rad)
    gammaEEL_short = gammaEELS(w_all=raw_w,wsp_long=wsp_long, wsp_short=wsp_short, gamNR_long=gamNR_long*gaml_scale, gamNR_short=gamNR_short*gams_scale,ebeam_loc=np.array([-120E-7, 192.42683E-7]),sph_rad=sph_rad)
